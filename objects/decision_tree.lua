...
function Decision_Tree.newTree()
    ...
    self.setBranch = Decision_Tree.setBranch
    self.update = Decision_Tree.update

    return self
end

function Decision_Tree:setBranch(branch)
    self.branch = branch
end

function Decision_Tree:update(dt)
...
function Decision_Tree.createAction(name, initializeFunction, updateFunction, cleanUpFunction, user)
...
function Decision_Tree.createEvaluator(name, evalFunction, user)
...
function Decision_Tree.createBranch(name, decorator)
